...
namespace _3_oop
{
    ...
    {
        public static Snake ValidateSnake(string name, string age, bool CanFly, string wings)
        {
            ...
            return new Snake(na.Value, int.Parse(ag.Value), CanFly, int.Parse(wi.Value), true);
